...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        MobileAds.initialize(getApplicationContext(), "ca-app-pub-1941549848807363~8752681133");
    ...
    private void setBoard() {
        ...
        textView.setText("Click on a box to start.");
        for (i = 1; i <= 3; i++) {
            for (j = 1; j <= 3; j++) {
    ...
    private boolean checkBoard() {
        ...
        if ((c[1][1] == 0 && c[2][2] == 0 && c[3][3] == 0)
            ...
            textView.setText("Well Done! You win!");
            gameOver = true;
